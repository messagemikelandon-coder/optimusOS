...
- [~] Part H — Security/production hardening. Approval-token revocation and multi-instance-safe (Redis-backed) rate limiting DONE (2026-07-14, merged); threat model, security event logging, OpenAI cost logging, retention/export/deletion policy, and monitoring requirements all still open.
