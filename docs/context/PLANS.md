...
- [~] Part H — Security/production hardening. Approval-token revocation DONE (2026-07-14, merged); threat model, multi-instance rate limiting, security event logging, OpenAI cost logging, retention/export/deletion policy, and monitoring requirements all still open.
