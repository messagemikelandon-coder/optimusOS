...
| 3. Context-management system | Maintain durable project context. | Repository docs and routing guidance. | `docs/context/` exists, root `AGENTS.md` routes correctly, and handoff rules are documented. | Product expansion. | Complete |
