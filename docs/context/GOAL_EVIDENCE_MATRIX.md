...
| Owner/manager/technician invitations | Technician provisioning exists and now creates a matching active Shop membership. Manager is a first-class account/membership role in migration 028 and receives operational owner-equivalent route access. Tokenized invitation creation/acceptance/revocation is still absent. | Partial | Phase 5 |
